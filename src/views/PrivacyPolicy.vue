...
onMounted(() => {
    document.title = 'Politique de confidentialité - Guillaume Cazin - Développeur web freelance'
})
</script>
...
<template>
    ...
    <Section title="Politique de confidentialité">
        <div class="space-y-4">
            <Text>
                Le site web www.guillaume-cazin.fr est détenu par Guillaume Cazin, qui est un contrôleur de données de vos données personnelles.
                Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par www.guillaume-cazin.fr, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d'utiliser le site web de www.guillaume-cazin.fr.
                Nous prenons soin de vos données personnelles et nous nous engageons à en garantir la confidentialité et la sécurité.
            </Text>

            <div>
                <Text type="subtitle">Les informations personnelles que nous collectons :</Text>
                <Text>
                    Lorsque vous visitez le www.guillaume-cazin.fr, nous recueillons automatiquement certaines informations sur votre appareil, notamment des informations sur votre navigateur web, votre adresse IP, votre fuseau horaire et certains des cookies installés sur votre appareil. En outre, lorsque vous naviguez sur le site, nous recueillons des informations sur les pages web ou les produits individuels que vous consultez, sur les sites web ou les termes de recherche qui vous ont renvoyé au site et sur la manière dont vous interagissez avec le site. Nous désignons ces informations collectées automatiquement par le terme "informations sur les appareils". En outre, nous pourrions collecter les données personnelles que vous nous fournissez (y compris, mais sans s'y limiter, le nom, le prénom, l'adresse, les informations de paiement, etc.) lors de l'inscription afin de pouvoir exécuter le contrat.
                </Text>
            </div>

            <div>
                <Text type="subtitle">Pourquoi traitons-nous vos données ?</Text>
                <Text>
           ...
           <div>
               ...
               <ul class="list-disc text-white space-y-1 mb-2">
            ...
            <div>
                ...
                <Text>
                    Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à contact@guillaume-cazin.fr.
                </Text>
            </div>
        </div>
    </Section>
